...
class RulePlayer(
        movementFuzzyness: Float = 0f
) : Player {
    val rulesCalculator = RulesCalculator(
            mapOf(
                    3f to PlayerRules.createAvoidHolesRule(200f, 20f),
                    ...
                    2.6f to PlayerRules.createAvoidHitboxesRule(100f)
    ...
    override fun onUpdate(controlledCharacterIndex: Int, gameState: SolGameState, charactersConfig: List<CharacterConfig>): SolActions {
        ...
        val fuzzyActions = PlayerUtils.appluFuzziness(actions,
                aimVariance = 0.2f,
                movementFuzzyness = 0.05f,
